...
namespace AspApp.Areas.ReportEditor.Controllers
{
    ...
    public class EditorController : Controller
    {
        ...
        private string _getAnonymousReportPath()
        {
            return Path.Combine(_dir, "Anonymous User", "new_report.xml");
        }
        ...
        public async Task<string> Report(int id)
        {
            ...
            {
                path = _getReportPath(id, User.Identity.Name);
            }
            try
            {
